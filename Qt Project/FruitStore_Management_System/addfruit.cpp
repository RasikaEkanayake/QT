...
AddFruit::AddFruit(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::AddItem)
{
    ui->setupUi(this);
    QPixmap pix ("C:/Resource/ct.jpg");
...
void AddFruit::on_btnAdd_clicked()
{
    ui->lblInfo->setText("");
    ...
    query.clear();
    query.prepare("insert into Fruit_items(Name, Quantity, Status, DOP, DOS, SellingPrice, PurchasePrice) values ('" +sName +"','" +sQuantity + "','"+ sStatus + "','" +sDOP + "','"+ sDOS+ "','"+sSellingPrice+ "','"+ sPurchasePrice + "')");
