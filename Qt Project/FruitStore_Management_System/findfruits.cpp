...
FindFruits::FindFruits(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::FindItem)
{
    ui->setupUi(this);
...
FindFruits::~FindFruits()
{
    delete ui;
}

void FindFruits::on_btnFind_clicked()
{
    ...
    query.prepare("select * from Fruit_items where " +sCriteriaColum+" like '%" + sValue + "%'");
